                ...
                dbc.Col(
                    [
                        ...
                        html.Div([
                            ...
                            html.Br(),
                            html.Label([
                                '3. Choose a Year and a State for a prediction that displays the relationship between the number of vaccinated animals and the number of undetected infectious animals'],
                                style={"text-align": "center"}),
                        ...
                        dcc.Graph(id='brucellosis-graph'),
...
@callback(
    dash.dependencies.Output('brucellosis-graph', 'figure'),
    [dash.dependencies.Input('year-dropdown', 'value'),
     dash.dependencies.Input('location-dropdown', 'value')])
def update_figure(selected_year, selected_location):
    filtered_data = data[(data['year'] == selected_year) & (data['departamento'] == selected_location)]
    fig = px.line(filtered_data, x='V', y='I')
    return fig
